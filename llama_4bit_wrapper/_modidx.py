...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'llama_4bit_wrapper.core': { 'llama_4bit_wrapper.core.Matmul4BitOptions': ( 'core.html#matmul4bitoptions',
                                                                                        'llama_4bit_wrapper/core.py'),
                                         'llama_4bit_wrapper.core._apply_flash_attention_monkeypatch': ( 'core.html#_apply_flash_attention_monkeypatch',
                                                                                                         'llama_4bit_wrapper/core.py'),
                                         ...
                                         'llama_4bit_wrapper.core._apply_xformers_monkeypatch': ( 'core.html#_apply_xformers_monkeypatch',
                                                                                                  'llama_4bit_wrapper/core.py'),
                                         'llama_4bit_wrapper.core._set_matmul_options': ( 'core.html#_set_matmul_options',
                                                                                          'llama_4bit_wrapper/core.py'),
